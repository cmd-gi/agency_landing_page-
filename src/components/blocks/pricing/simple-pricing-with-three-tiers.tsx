        ...
        >
          <div className="flex justify-between items-start ">
            <div className="flex gap-2 flex-col">
              <p
                className={classNames("font-medium text-lg text-black dark:text-white")}
              >
                {plan.name}
              </p>
            </div>
...
const Step = ({
  ...
  return (
    <div className="flex items-start justify-start gap-2 my-4">
      ...
      <div className={classNames("font-medium text-black text-sm dark:text-white")}>
        {children}
      </div>
    </div>
  );
...
const Divider = () => {
  return (
    <div className="relative">
      <div className={classNames("w-full h-px dark:bg-neutral-950 bg-white")} />
      <div className={classNames("w-full h-px bg-neutral-200 dark:bg-neutral-800")} />
      <div
        className={classNames(
